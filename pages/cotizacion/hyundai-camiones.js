      ...
      <Container fluid={true} className="cotizacion">
        ...
        <Row style={{ marginBottom: '90px'}}>
          <Col className="mt-2 mb-3">
            ...
            <Link href="/cotizacion/hyundai-camiones/"><a className="btn btn-default m-0 mt-3 w-100 mb-0">ENGLISH</a></Link>
            <Link href="/cotizacion/hyundai-camiones-es/"><a className="btn btn-default m-0 mt-1 w-100">ESPAÑOL</a></Link>
          </Col>
          <Col xs={12} md={10}>
            ...
            <hr/>
            <p><b></b>Design, develop, deploy, support, maintain and host <b>HYUNDAI CAMIONES Y BUSES</b>.</p>
            <hr/>
            <h5><b><span class="lnr lnr-plus-circle"></span> Requirements</b></h5>
            <hr/>
            <ul>
              <li>Redesign of the <b>HYUNDAI CAMIONES Y BUSES</b>, taking on account the preference of being able to get information from our existing platform</li>
              <li>Redesign of the Corporate microsites with two different quotes: With HYUNDAI dealers & Without HYUNDAI distributors</li>
            ...
            <hr/>
            <h4><span class="lnr lnr-arrow-right"></span> HYUNDAI CAMIONES Y BUSES</h4>
            <hr/>
            ...
            <Table striped bordered hover size="sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Online service software for customers and visitors of the different HYUNDAY CAMIONES Y BUSES web platforms.</td>
            ...
            <hr/>
            <h5><span class="lnr lnr-plus-circle"></span> <b>IMPORTANT NOTES</b></h5>
            <hr/>
            <ul>
